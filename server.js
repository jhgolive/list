  ...
  if (cached) {
    ...
    if (!part) {
      ...
      const heart = liked
        ...
        : `<a href="#" onclick="like();return false;" style="text-decoration:none;font-size:14px;display:inline-block;line-height:1;transform: translateY(0px) scaleX(1.1);-webkit-text-stroke: 1.2px #555;color:transparent;">♡</a>`;
