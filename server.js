  ...
  if (cached) {
    ...
    if (!part) {
      ...
      const heart = liked
        ...
        : `<a href="#" onclick="like();return false;" style="text-decoration:none;font-size:14px;display:inline-block;line-height:0;transform: translateY(1px) scaleX(1.3);-webkit-text-stroke: 1.1px #555;color:transparent;">♡</a>`;
